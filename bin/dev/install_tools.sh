...
configgin_url="${configgin_url:-https://region-b.geo-1.objects.hpcloudsvc.com/v1/54026737306152/aaa-swift-client-test/configgin-0.12.0%2B14.ge8cf926.develop-linux-amd64.tgz}"
