...
configgin_url="${configgin_url:-https://15.184.137.5:8080/v1/AUTH_7b52c1fb73ad4568bbf5e90bead84e21/hcf-ci-concourse-configgin/configgin-0.12.0%2B12.gea70828.HEAD-linux-amd64.tgz}"
fissile_url="${fissile_url:-https://api.mpce.hpelabs.net:8080/v1/AUTH_7b52c1fb73ad4568bbf5e90bead84e21/hcf-ci-concourse-fissile/fissile-0.12.0%2B146.g0571438.HEAD-linux.amd64.tgz}"
...
wget --no-check-certificate -q "$configgin_url" -O $tools_dir/configgin.tgz
echo "Fetching cf CLI ..."
wget -q "$cf_url"        -O $tools_dir/cf.tgz
echo "Fetching fissile ..."
wget --no-check-certificate -q "$fissile_url"   -O - | tar xz -C $bin_dir fissile
echo "Fetching gato ..."
