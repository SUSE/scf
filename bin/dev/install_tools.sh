...
fissile_url="${fissile_url:-https://region-b.geo-1.objects.hpcloudsvc.com/v1/54026737306152/hcf-ci-concourse/fissile-0.11.0%2B104.gfc0843f.HEAD-linux.amd64.tgz}"
