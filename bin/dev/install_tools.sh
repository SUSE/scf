...
configgin_url="${configgin_url:-https://helion-developers.s3.amazonaws.com/viovanov/hcf/configgin-1.0.0%2B21.g9d838f1.develop-linux-amd64.tgz}" # Favor configgin 1.0.4!
