...
fissile_url="${fissile_url:-https://region-b.geo-1.objects.hpcloudsvc.com/v1/54026737306152/fissile-artifacts/fissile-1.0.1.34_develop%2Fbuild%2Flinux-amd64%2Ffissile}"
