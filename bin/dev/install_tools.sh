...
configgin_url="${configgin_url:-https://concourse-hpe.s3.amazonaws.com/configgin-1.1.0%2B7.ga6a0f12.develop-linux-amd64.tgz}"
fissile_url="${fissile_url:-https://concourse-hpe.s3.amazonaws.com/fissile-2.0.2%2B69.g036e756.develop-linux.amd64.tgz}"
