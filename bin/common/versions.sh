...
export FISSILE_VERSION="5.1.0+58.g3bf0ca7"
...
then
	export FISSILE_STEMCELL_VERSION=${FISSILE_STEMCELL_VERSION:-42.2-17.g29bfba7-29.81}
else
	export FISSILE_STEMCELL_VERSION=${FISSILE_STEMCELL_VERSION:-12SP3-5.g5fc0351-0.75}
fi
