...
stampy ${ROOT}/hcf_metrics.csv create-release ${release_name}-start

stampy ${ROOT}/hcf_metrics.csv create-release ${release_name}-docker-start
docker run \
    --interactive \
    --rm \
...
stampy ${ROOT}/hcf_metrics.csv create-release ${release_name}-docker-done
...
stampy ${ROOT}/hcf_metrics.csv create-release ${release_name}-y2j-start
...
stampy ${ROOT}/hcf_metrics.csv create-release ${release_name}-y2j-done

stampy ${ROOT}/hcf_metrics.csv create-release ${release_name}-done
