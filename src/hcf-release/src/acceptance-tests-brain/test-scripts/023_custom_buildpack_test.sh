...
CF_BUILDPACK="buildpack-$(random_suffix)"
...
function test_cleanup() {
    ...
    cf delete-buildpack -f ${CF_BUILDPACK} 
...
# push an app
cd ${SELFDIR}/../test-resources
cf create-buildpack ${CF_BUILDPACK} staticfile_buildpack-cached-v1.4.4.zip 5 --enable

cd ${SELFDIR}/../test-resources/${APP_DIR}
cf push ${APP_NAME} -b ${CF_BUILDPACK}
