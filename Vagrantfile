...
Vagrant.configure(2) do |config|
  ...
  config.vm.provider "virtualbox" do |vb, override|
    ...
    override.vm.box = "https://s3-us-west-2.amazonaws.com/hcf-vagrant-box-images/hcf-virtualbox-v1.0.7.box"
  ...
  config.vm.provider "vmware_fusion" do |vb, override|
    override.vm.box="https://s3-us-west-2.amazonaws.com/hcf-vagrant-box-images/hcf-vmware-v1.0.7.box"
