...
PATCH_DIR=/var/vcap/jobs-src/loggregator_agent/templates
...
--- bpm.yml.erb	2019-02-13 15:14:45.921819105 -0800
+++ bpm.yml.erb	2019-02-13 15:16:27.174149591 -0800
@@ -41,3 +41,10 @@
       AGENT_PPROF_PORT: "<%= p("pprof_port") %>"
