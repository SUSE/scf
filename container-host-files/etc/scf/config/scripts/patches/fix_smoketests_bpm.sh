...
PATCH_DIR=/var/vcap/jobs-src/smoke_tests/templates
...
--- bpm.yml.erb	2019-02-15 15:41:26.747625747 -0800
+++ bpm.yml.erb	2019-02-15 15:42:17.943498267 -0800
@@ -1,3 +1,10 @@
 processes:
   - name: smoke_tests
     executable: /var/vcap/jobs/smoke_tests/bin/test
+    unsafe:
