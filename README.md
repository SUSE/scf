...
The Cloud Controller Database encrypts app environment variables. By default,
the encryption key is [generated by SCF](https://github.com/SUSE/scf/blob/2d095a71008c33a23ca39d2ab9664e5602f8707e/container-host-files/etc/scf/config/role-manifest.yml#L1656-L1662).
If it's compromised and needs to be rotated, new keys can be added. Note that
existing encrypted variables will **not** be updated. The environment variables
must be set again to have them reencrypted with the new key.
...
originally generated key is still being used.
